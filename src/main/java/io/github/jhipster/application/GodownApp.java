...
public class GodownApp {

    private static final Logger log = LoggerFactory.getLogger(GodownApp.class);

    private final Environment env;

    public GodownApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GodownApp.class);
